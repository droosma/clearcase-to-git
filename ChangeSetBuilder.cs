...
namespace GitImporter
{
    public class ChangeSetBuilder
    {
        ...
        public ChangeSetBuilder(ChangeSet changeSet,
                ...
                for(int i = added.Count - 1;i >= 0;i--)
                {
                    ...
                    if(matching != null && previousVersion != null && !previousVersion.Content.Any(p => p.Value == matching.Item1))
                    {
                        Logger.TraceData(TraceEventType.Warning,
                                         ...
                                         "Erasing added and at the same time removed version",
                                         matching.Item1,
                                         matching.Item2);
                        added.RemoveAt(i);
        ...
        /// </summary>
        private List<KeyValuePair<Element, string>> ProcessRemove(List<KeyValuePair<Element, List<Tuple<Element, string>>>> removedElements,
                                                                  List<KeyValuePair<Element, List<Tuple<Element, string>>>> addedElements)
        {
        ...
        private void ProcessRename(List<KeyValuePair<Element, string>> renamedElements,
                                   List<KeyValuePair<Element, List<Tuple<Element, string>>>> addedElements)
        {
        ...
        private void RemoveElementName(Element element,
                                       string elementName,
