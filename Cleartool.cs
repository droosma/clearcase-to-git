...
namespace GitImporter
{
    ...
    {
        private const string cleartool = "cleartool_tty.exe";
        private const int nbRetry = 15;
        ...
        public Cleartool(string clearcaseRoot, LabelFilter labelFilter)
        {
            ...
            var startInfo = new ProcessStartInfo(cleartool)
                            {
        ...
        private List<string> ExecuteCommand(string cmd)
        {
            ...
            Logger.TraceData(TraceEventType.Error, (int)TraceId.Cleartool, "Cleartool command failed " + nbRetry + " times, aborting", cmd);
        ...
        public void GetLabelDetails(string label,
